      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-white/5 backdrop-blur-3xl rounded-[3rem] p-10 border border-white/10 shadow-2xl">
          <div className="text-center mb-12">
            ...
            <p className="text-white/30 font-bold uppercase tracking-[0.3em] text-[10px]">Bihar's Construction Network</p>
          </div>

          <div className="space-y-6">
            <div>
              <label className="text-[10px] font-black uppercase text-white/40 ml-4 mb-2 block">Email</label>
              <input 
